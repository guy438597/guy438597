    ...
    */
    ...
    run: function(creep) {
        ...
        if (creep.memory.state == "pickupEnergy") {
            ...
            if (target == undefined){
                target = findEnergy(creep, 500, undefined, STRUCTURE_CONTAINER, "withdraw", Memory.structures.miningContainers);
                target2 = findEnergy(creep, 500, undefined, STRUCTURE_STORAGE, "withdraw", Memory.structures.miningContainers);
