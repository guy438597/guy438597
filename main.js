...
module.exports.loop = function() {
  var attackTarget, basicEconomyRunning, c, closestSpawn, combinedTicksEnergyRefiller, countBodyParts, countWalkableTiles, creep, energy, energyMax, energySource, energyTransporterConstant, healTarget, i, item, j, k, key, l, len, len1, len10, len11, len12, len13, len2, len3, len4, len5, len6, len7, len8, len9, location, m, maxBodyParts, maxMiners, miner, minimumNumberOfBuilders, minimumNumberOfEnergyRefillers, minimumNumberOfRepairers, minimumNumberOfUpgraders, moreMinersRequired, n, name, newClaimerRequired, newbuildingSites, newrepairTargets, o, p, q, r, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, repairTarget, results, results1, roleCnt, room, roomName, s, source, sourceID, sourceRoomName, spawn, spawnHighPriorityDefense, spawnLowPriorityAttack, spawnName, spawning, t, tempDistance, totalEnergyTransportersRequired, tower, towers, u, v, w, x, y;
  ref = Memory.creeps;
  for (name in ref) {
    creep = ref[name];
  ...
  ref1 = Memory.energy.energySources;
  for (i = k = 0, len = ref1.length; k < len; i = ++k) {
    ...
    if (Memory.energy.energySourceMiners[i].length > 0) {
      ref2 = Memory.energy.energySourceMiners[i];
  ...
  ref3 = Memory.claims.claimClaimers;
  ...
  ref4 = Memory.claims.claimLocations;
  ...
  for (o = 0, len4 = towers.length; o < len4; o++) {
    tower = towers[o];
  ...
  if (Game.time % 30 === 0) {
    ...
    for (name in ref5) {
      ...
      for (p = 0, len5 = newrepairTargets.length; p < len5; p++) {
        i = newrepairTargets[p];
        Memory.structures.repairTargets = Memory.structures.repairTargets.concat((function() {
          var len6, q, ref6, results;
          results = [];
          for (q = 0, len6 = newrepairTargets.length; q < len6; q++) {
            s = newrepairTargets[q];
            if (ref6 = s.id, indexOf.call(Memory.structures.repairTargets, ref6) < 0) {
              results.push(s.id);
            }
          }
          return results;
      ...
      for (q = 0, len6 = newbuildingSites.length; q < len6; q++) {
        i = newbuildingSites[q];
        Memory.structures.buildingSites = Memory.structures.buildingSites.concat((function() {
          var len7, r, ref6, results;
          results = [];
          for (r = 0, len7 = newbuildingSites.length; r < len7; r++) {
            s = newbuildingSites[r];
            if (ref6 = s.id, indexOf.call(Memory.structures.buildingSites, ref6) < 0) {
              results.push(s.id);
            }
          }
          return results;
  ...
  ref7 = Memory.energy.energySourceTransporters[i];
  for (i = r = 0, len7 = ref7.length; r < len7; i = ++r) {
    name = ref7[i];
    console.log(i);
  ...
  if (!(Game.time % 30)) {
    ...
    ref8 = Memory.energy.energySources;
    for (i = t = 0, len8 = ref8.length; t < len8; i = ++t) {
      ...
      if (source) {
        closestSpawn = chooseClosest(source, (function() {
          ...
          ref9 = Game.spawns;
          results = [];
          for (spawnName in ref9) {
            spawn = ref9[spawnName];
            results.push(spawn);
          }
          return results;
        })());
  ...
  if (!spawning && (energy >= 200 && !basicEconomyRunning || energy >= energyMax)) {
    if (energy >= 190 && spawnHighPriorityDefense) {
      ...
      if (Memory.energy.energySourceMiners) {
        ...
        for (i = u = 0, len9 = ref9.length; u < len9; i = ++u) {
          ...
          if (Memory.energy.energySourceMiners[i]) {
            ref10 = Memory.energy.energySourceMiners;
            for (j = v = 0, len10 = ref10.length; v < len10; j = ++v) {
              miner = ref10[j];
              ref11 = Memory.energy.energySourceMiners[i];
      ...
      ref12 = Memory.energy.energySources;
      for (i = x = 0, len12 = ref12.length; x < len12; i = ++x) {
        energySource = ref12[i];
        sourceID = Memory.energy.energySources[i][0];
        ...
        if (source) {
          closestSpawn = chooseClosest(source, (function() {
            ...
            ref13 = Game.spawns;
            results1 = [];
            for (spawnName in ref13) {
              spawn = ref13[spawnName];
              results1.push(spawn);
            }
            return results1;
          })());
