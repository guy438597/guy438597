...
var minimumNumberOfSourceMiner = 1;
...
module.exports.loop = function () {
    ...
    */
    ...
    var numberOfSourceMiner = _.sum(Game.creeps, (c) => c.memory.role == 'sourceMiner');
    var numberOfEnergyCarrier = _.sum(Game.creeps, (c) => c.memory.role == 'energyCarrier');
    ...
    // if not enough harvesters
        ...
        else if (energy >= 250 && numberOfSourceMiner < minimumNumberOfSourceMiner) {
            // try to spawn one
            name = Game.spawns.spawn1.createCustomCreepV2(energy, 'sourceMiner');
        }
        else {
